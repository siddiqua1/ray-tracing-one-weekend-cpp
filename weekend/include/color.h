...
void write_color(Write &file, const color &pixel_color)
{
    auto r = pixel_color.x();
    auto g = pixel_color.y();
    auto b = pixel_color.z();
...
void write_color(std::vector<std::tuple<int, int, int>> &stream, const color &pixel_color)
{
    auto r = pixel_color.x();
    auto g = pixel_color.y();
    auto b = pixel_color.z();
...
void write_color(std::vector<std::tuple<int, int, int>> &stream, const color &pixel_color, size_t idx)
{
    auto r = pixel_color.x();
    auto g = pixel_color.y();
    auto b = pixel_color.z();
